    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                echo "<td>" . "<a href='editocc.php?id=".$row['oid']."' class='badge bg-success'>Edit</a> <a href='deleteocc.php?id=".$row['oid']."' class='badge bg-danger' onclick='return DeleteConfirm()'>Trash</a>". "</td>";
            echo "</tr>";
        }
        echo "</table>";
        // Free result set
...
<script>
    function DeleteConfirm() {
      return confirm("Are you sure you want to delete this occupation record?");
     }
 </script>
</html>
